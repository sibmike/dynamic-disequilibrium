...
another finds the opposite \citep{doukas2006}; \citet{moffitt2017}
summarises the impasse. The empirical record is messy, and we will
argue this is exactly what one should expect.
...
winning-bid value. The 2021 wind-down of Zillow's algorithmic-iBuying
programme \citep{zillow2021ibuying} is one episode in which a
clearing-price-anchored valuation system at scale incurred
substantial losses; the public record is consistent with the
mechanism described here, though we do not advance EDEM as a
complete account of that specific event.
