...
prototypes whose NetLogo source is preserved in the
\path{drafts/netlogo/} subdirectory of the same repository. The
...
NetLogo code cannot. The Mesa port, the NetLogo source, and the
present paper are released together at
\url{https://github.com/sibmike/dynamic-disequilibrium} --- code under MIT,
